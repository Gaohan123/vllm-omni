...
from typing import TYPE_CHECKING, Any, Optional, Final, Union
...
from vllm.entrypoints.harmony_utils import parse_chat_output, get_streamable_parser_for_assistant
...
class OmniOpenAIServingChat(OpenAIServingChat, AudioMixin):
    ...
    async def chat_completion_stream_generator(
        ...
        assert hasattr(request, "modalities") and request.modalities is not None, "Streaming request must specify output modalities"
        ...
        try:
            async for omni_res in result_generator:
                ...
                if first_iteration_dict[final_output_type]:
